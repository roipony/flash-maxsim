"""End-to-end benchmark with GVE Embedding model.

Uses <anonymised-vision-encoder> (multi-vector, MaxSim-based).
Benchmarks Flash-MaxSim as drop-in replacement for the model's scoring.

Usage:
    pip install -e . transformers pillow requests
    python benchmarks/bench_gve.py

Produces: benchmarks/results_gve_<GPU>.json
"""
import json, torch
...
# ── Load model ──
print("Loading GVE Embedding model...")
from transformers import AutoProcessor, AutoModel

model_name = "<anonymised-vision-encoder>"
...
out = f"benchmarks/results_gve_{gpu_tag}.json"
